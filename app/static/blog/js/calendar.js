...
var calendar = function(calendarId){
    ...
    c.init = function(){
        ...
        loadStyles(".calendarDiv {width:260px;text-align:center;}\
            .Table{width:260px;height:200px;margin-top:10px;}\
            .box{margin-left:15px;margin-right:15px;text-align:center;width:230px;height:22px;font-weight:bold;font-size:21px;}\
            ...
            .redTr{color:yellow;text-align:center;background:red;border-radius:50%;}\
